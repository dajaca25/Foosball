...
public class egGame : MonoBehaviour {
	...
	public float sukiPlacement;
	public float sukiJoystick;
	...
	void Update () {
		egUpdate ();
		sukiPlacement = suki.GetRange("placement");
		sukiJoystick = suki.GetRange("joystick");
	}
...
//			print("placement mode:" + range + ":" + xPercent);
			...
			pos.x = (xPercent * Speed); // we use speed as a position scaler
